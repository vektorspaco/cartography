...
**[Dispersión Poblacional Patagónica](https://github.com/vektorspaco/cartography/blob/main/patagonia_dispersion_poblacional.html)** — primer proyecto del repo. Mapa interactivo de la Patagonia argentina y chilena donde cada localidad aparece con radio proporcional a √población. Incluye buscador, filtros por país y población mínima, y permite armar un recorrido tocando localidades y abrirlo en Google Maps.
